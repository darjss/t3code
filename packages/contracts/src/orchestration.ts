...
const ThreadTurnCompactCommand = Schema.Struct({
  type: Schema.Literal("thread.turn.compact"),
  commandId: CommandId,
  threadId: ThreadId,
  createdAt: IsoDateTime,
});
...
export const ThreadTurnCompactRequestedPayload = Schema.Struct({
  threadId: ThreadId,
  createdAt: IsoDateTime,
});
...
export const OrchestrationEvent = Schema.Union([
  ...
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("thread.turn-compact-requested"),
    payload: ThreadTurnCompactRequestedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
